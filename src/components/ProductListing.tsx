        ...
        <div className="bg-white px-4 py-10 md:px-24">
            <div className=" lg:flex items-start gap-8 ">
                <div className="flex gap-4 lg:hidden">
                    <button className="border border-[#D4D4D4] font-medium rounded-lg text-sm p-3 text-center inline-flex items-center text-blue-primary-60 " type="button">
                        <p>Filter</p> 
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ms-12">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
                    </svg>
                    </button>
                    <button className="border border-[#D4D4D4] font-medium rounded-lg text-sm p-3 text-center inline-flex items-center text-blue-primary-60" type="button">
                        <p>By Rating </p><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ms-4 text-[#9F9F9F]">
