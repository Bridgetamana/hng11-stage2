        ...
        <div className="px-4 py-6 md:px-24">
            {cartItems.length === 0 ? (
                <div className="text-center my-8">
                    ...
                    <Link to='/' className="text-blue-primary-60 underline hover:no-underline">Back to shopping</Link>
                </div>
            ) : (
                <>
                    <div className="md:text-center flex flex-col md:flex-col-reverse gap-y-6 md:mt-20 ">
                        <Link to='/'>
                            <span className="text-[#001845] border-b-2 border-[#001845] ml-3 hover:no-underline">
                                Back to shopping
                            </span>
                        </Link>
                        <h3 className="text-2xl lg:flex justify-center pl-3">Your cart items</h3>
                    </div>
                    ...
                    <div className="my-6 md:hidden">
                        ...
                        <div className="px-3 py-10 border border-[#EBEBEB] rounded-xl">
                            <form>
                                ...
                                <Link to='/step1'>
                                    <button className="bg-blue-primary-60 text-white py-2.5 text-center w-full rounded-xl mt-6 hover:bg-blue-primary-60 /90">Checkout</button>
                                </Link>
                            </form>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:block my-12">
                        ...
                        <div className="flex justify-between items-center my-12">
                            ...
                            <Link to='/step1'>
                                <button className="bg-blue-primary-60 text-white py-2.5 md:px-8 lg:px-12 text-center w-full rounded-xl mt-6 hover:bg-blue-primary-60/90">Checkout</button>
                            </Link>
                        </div>
                    </div>
                </>
